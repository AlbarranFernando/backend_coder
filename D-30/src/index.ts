...
if (process.argv[5] === "CLUSTER") {modoCluster = true}
if (process.argv[5] === "FORK") {modoCluster = false} //Redundante
////////////Objeto Process FIN////////////// 
...
app.use('/',router)
  ...
  if (PORT == 'undefined') {PORT = 3000};// Fallo de asignacon de linea superior
