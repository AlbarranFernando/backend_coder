...
let FACEBOOK_CLIENT_ID = process.env.FACE_ID_CODER || '158920966254676';
let FACEBOOK_CLIENT_SECRET = process.env.FACE_SECRET_CODER || 'f0e54ad4fa5eaf9426721aa42850fbff';
if (FACEBOOK_CLIENT_ID == 'undefined') {FACEBOOK_CLIENT_ID = '158920966254676'};// Fallo de asignacon de linea superior
if (FACEBOOK_CLIENT_SECRET == 'undefined') {FACEBOOK_CLIENT_SECRET = 'f0e54ad4fa5eaf9426721aa42850fbff'};// Fallo de asignacon de linea superior
